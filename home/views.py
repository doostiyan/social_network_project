...
from home.forms import PostCreateUpdateForm, CommentReplyForm, CommentCreateForm, PostSearchForm
...
class PostDeleteView(LoginRequiredMixin, View):
    def get(self, request, post_id):
        ...
        if post.user.id == request.user.id:
            ...
            messages.error(request, 'you do not have permission to', 'danger')
